...
public class Main {
    ...
    public static void CompareResultset(ResultSet resultSet1, ResultSet resultSet2) throws SQLException {
        String comparedResult = " Similar Data's in the Table";
        try {
                ...
                for (int columCount = 1; columCount <= rsColumn1; columCount++) {
                    ...
                    columnType == Types.SMALLINT) {
                        ...
                        if (!colValue1.equals(colValue2)) {
                            comparedResult = "Data MisMatch Found in Column - " + columCount + " of value " + "'" + colValue1 +
                                    "'" + " with " + "'" + colValue2 + "'";
                            System.out.println(comparedResult);
                            break;
                        }
                    } else if (columnType == Types.CHAR || columnType == Types.LONGVARCHAR || columnType == Types.VARCHAR) {
